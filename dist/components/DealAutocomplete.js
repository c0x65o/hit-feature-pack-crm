...
export function DealAutocomplete({ value, onChange, label = 'Related Deal', placeholder = 'Search for a deal...', disabled = false, }) {
    ...
    return (_jsxs("div", { ref: containerRef, className: "relative", children: [_jsxs("div", { className: "relative", children: [selectedDeal && (_jsx("button", { type: "button", onClick: handleClear, className: "absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 z-10", style: { marginTop: '12px' }, children: "\u00D7" })), _jsx(Input, { label: label, value: searchQuery, onChange: handleInputChange, placeholder: placeholder, disabled: disabled })] }), showSuggestions && !selectedDeal && (_jsx("div", { style: {
                ...
                }, children: loading ? (_jsx("div", { style: { padding: '12px 16px', textAlign: 'center', color: 'var(--text-muted, #888)' }, children: "Searching..." })) : deals.length === 0 ? (_jsx("div", { style: { padding: '12px 16px', textAlign: 'center', color: 'var(--text-muted, #888)' }, children: "No deals found" })) : (deals.map((deal) => (_jsxs("div", { onClick: () => handleSelectDeal({ id: deal.id, name: deal.dealName }), style: {
                        padding: '12px 16px',
                        cursor: 'pointer',
                        display: 'flex',
                        alignItems: 'center',
                    ...
                    }, children: [_jsx(TrendingUp, { size: 16, style: { color: 'var(--text-muted, #888)' } }), _jsxs("div", { style: { flex: 1 }, children: [_jsx("div", { style: { fontWeight: 500, marginBottom: '2px' }, children: deal.dealName }), deal.amount && (_jsx("div", { style: { fontSize: '12px', color: 'var(--text-muted, #888)' }, children: formatCurrency(deal.amount) }))] })] }, deal.id)))) }))] }));
}
